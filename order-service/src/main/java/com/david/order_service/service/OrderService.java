package com.david.order_service.service;

import com.david.order_service.model.Order;
...
public class OrderService {
    ...
    public OrderResponse placeOrder(String customerUsername, PlaceOrderRequest request) {
        ...
        CustomerResponse customer = customerClient.getCustomerByUsername(customerUsername);
